...
module.exports = {
  input: {
    path: "./certificate_generator/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./certificate_generator/locale", // output path of all created files
