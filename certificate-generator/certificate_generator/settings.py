...
APP_NAME = "certificate_generator"
...
DATATYPE_LOCATIONS.append("certificate_generator.datatypes")
FUNCTION_LOCATIONS.append("certificate_generator.functions")
ETL_MODULE_LOCATIONS.append("certificate_generator.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("certificate_generator.search_components")
...
SECRET_KEY = "django-insecure-0t1n+74wol*a@3j3!#@)=g9y3git1t8u%d2q$0wic2@ip7($v9"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "certificate_generator.urls"
ROOT_HOSTCONF = "certificate_generator.hosts"

DEFAULT_HOST = "certificate_generator"
...
ELASTICSEARCH_PREFIX = "certificate_generator"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'certificate_generator.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    "pgtrigger",
    # "silk",
    "certificate_generator",  # Ensure the project is listed before any other arches applications
)
...
SESSION_COOKIE_NAME = "certificate_generator"
...
# ES_MAPPING_MODIFIER_CLASSES = ["certificate_generator.search.es_mapping_modifier.EsMappingModifier"]
